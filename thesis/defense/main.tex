...
\begin{frame}
  ...
  \onslide<3->{\item \textsf{软件测试}
    ...
    \end{itemize}}
  \end{enumerate}
\onslide<5->{\fbox{\textbf{正确}并\alert{高效}地进行补丁验证}}\\
...
\begin{frame}
  ...
  \item 给出由现有程序的\rbscope 生成可供验证驱动程序进行\textit{交叉验证} 的实现
...
\begin{frame} %[<+->]
  \frametitle{实验方法}
  \begin{itemize}
  \item[\ding{43}] 通过Emacs扩展将程序\prog 的\prog\entry , \prog\bs , \prog\ps 信息写入配置文件config.json中。
  ...
  \item[\ding{43}] 对klee-input.bc 进行符号执行，判断补丁正确性
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{table}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
      \hline
      编号 & 程序名 & \patch\ps & \patch\bs& 类型 & \patch\scope 大小(Kb) & $T_{rbc}$(ms)& \patch 大小(Kb) \\
      \hline
      01 & cut & 620 & 624 &  \onslide*<3->{\color{green}{添加}} &2.6 & 106 & 181\\ \hline
      02 & factor & 114 & 121 &  \onslide*<2->{\color{yellow}{修改}} & 2.2 & 62 & 139\\ \hline
      03 & join & 642 & 586 & \onslide*<2->{\color{yellow}{修改}} & 1.8& 54& 168\\ \hline
      04 & mv & 461 & 465 &  \onslide*<2->{\color{yellow}{修改}} & 2.8 & 62 & 404 \\ \hline
      05 & od & 881 & 991 &  \onslide*<2->{\color{yellow}{修改}} & 2.0 & 60 & 193 \\ \hline
      06 & od & 1,290 & 1,389 &  \onslide*<2->{\color{yellow}{修改}} & 3.7 & 60 & 193\\ \hline
      07 & rm & 322 & 347 &  \onslide*<2->{\color{yellow}{修改}} & 1.8 & 71 & 257 \\ \hline
      08 & tail & 139 & 638 &  \onslide*<2->{\color{yellow}{修改}} & 2.7 & 89 & 210 \\ \hline
      09 & tr & 419 & 1,107 & \onslide*<2->{\color{yellow}{修改}} & 2.1 & 56 & 187 \\ \hline
      10 & tr & 898 & 810 &  \onslide*<2->{\color{yellow}{修改}} & 8.9 & 55 & 187 \\ \hline
      11 & tr & 422 & 1,107 & \onslide*<4->{\color{red}{删除}} & 2.2 & 54 & 187 \\ \hline
      12 & tsort & 140 & 170 &  \onslide*<2->{\color{yellow}{修改}} & 4.9 & 63 & 141 \\ \hline
    \end{tabular}
    \label{tab:cases}
  \end{table}
\end{frame}
...
\begin{frame}
  ...
  \begin{table}
    ...
    \begin{tabular}{|p{0.80cm}|c|c|c|c|r|}
      ...
      & original & 否 & \alert<2->{\ding{55}} &  \alert<2->{\ding{55}} & \alert<2->{\ding{55}}  \\
      \hline
...
\begin{frame}
  \transdissolve<2->
  \frametitle{对{\color{yellow}{错误肯定}}和{\color{yellow}{回归错误}}的评估}
  \begin{table}
    \centering
    \scriptsize
    \begin{tabular}{|c|c|c|c|c|}
      ...
      01 & 否 & 0.79 & 是 & 1.08 \\ \hline
      02 & - &超时 & - & 超时 \\ \hline
      03 & 否 &5.64 & 是 & 1.09 \\ \hline
      04 & - &超时 & - & 超时 \\ \hline
      05 & - &超时 & - & 超时 \\ \hline
      06 & 否 & 540.84 & 是 & 114.54 \\ \hline
      07 & \alert<2->{是} & 2.09 & \alert<3->{否} & 9.17 \\ \hline
      08 & 否 & 8.50 & \alert<3->{否} & 7.26 \\ \hline
      09 & 否 & 8.03 & 是 & 2.01 \\ \hline
      10 & - &超时 & - & 超时 \\ \hline
      11 & 否 & 93.40 & 是 & 2.11 \\ \hline
      12 & 否 & 7.94 & 是 & 3.02 \\ \hline
    \end{tabular}
    \label{tab:eval2}
  \end{table}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \begin{itemize}
      ...
      \item 在LLVM、KLEE及STP的基础上实现了反映该思想的工具\dryrun
...
\begin{frame}
  \transdissolve
  \begin{centering}
    \Huge\color{yellow} {\shuti{谢\quad 谢!}}\par
  \end{centering}
\end{frame}
