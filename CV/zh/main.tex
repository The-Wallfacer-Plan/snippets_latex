...
\setCJKmainfont[ItalicFont={KaiTi_GB2312}, BoldFont={SimHei}]{STZhongsong}%衬线字体 缺省中文字体为
...
\mobile{+65 8547 6746}                    % optional, remove the line if not wanted
...
\section{工作经历}
\cventry{2019.08-目前}{南洋理工大学}{副研究员}{}{}{扩展并维护模糊测试框架FOT, 该框架结合了现有的模糊测试技术, 并强调使用静态分析来指导模糊测试, 项目主页\url{https://sites.google.com/view/fot-the-fuzzer}。}
\cventry{2014.05-2015.08}{南洋理工大学}{副研究员}{}{}{基于LLVM的数据流分析, 该项目主要为了精化数据流分析来指导动态测试的有效性。}
\cventry{2013.02-2014.11}{微软亚洲研究员}{实习生}{}{}{通过静态分析提高白盒测试程序补丁的有效性; 实现了对补丁程序切片静态代码分析工具,使得被切片后的程序可以有效地用于白盒测试。}
\section{教育经历}
...
\section{科研项目}
% \subsection{科研项目}
\cvline{FOT}{2017.07至今\quad 开发并维护模糊测试框架FOT~\cite{fse18-fot}, 该框架结合了现有的模糊测试技术, 并强调使用静态分析来指导模糊测试。FOT已经检测了100+开源软件并从其中找到了300+漏洞, 其中61个被赋予CVE编号, 具体漏洞详见\url{https://hongxuchen.github.io/}和\url{https://github.com/ntu-sec/pocs}. FOT获NASAC2017原型竞赛(命题组)一等奖, 并作为工具论文被CCF-A类会议ESEC/FSE 2018所接受。基于该框架的Hawkeye和Cerebro分别被CCF-A类会议CCS 2018和ESEC/FSE 2019所接受。}
\cvline{Hawkeye}{2018.01-2018.05\quad 设计并提出导向性模糊测试技术Hawkeye~\cite{hawkeye}, 提出了导向性模糊测试的4个属性及解决方案,并用实验论证了有效性。 该技术被CCF-A类会议CCS 2018所接受。}
\cvline{STAndroid}{2015.08-2017.06\quad 该项目立足于Android系统的权限系统, 利用类型系统验证依赖于权限的信息流安全; 我设计并完成了对类型系统健壮性的形式化验证, 并实现了基于此的信息泄露检测工具原型。该工作被CCF-B类会议CSF 2018所接受。}
...
\section{技能}
\cvline{\textbf{精通}}{Java, Python, Rust, 静态分析, 模糊测试, 符号执行}
\cvline{\textbf{熟练}}{LLVM/GCC, Linux编程, Bash, JVM}
\cvline{\textbf{了解}}{Radare2, OCaml, Haskell, Coq, Isabelle}
