...
\cventry{2019.08~$\sim$~present}{Nanyang Technological University}{Research Associate}{Singapore}{}{I maintain the fuzzing framework FOT. Meanwhile, I am also involved in high-performance cross-CPU binary fuzzing framework BiFF, as well as a fuzzing technique called MUZZ that aims to boost fuzz testing on multithreaded programs. }
