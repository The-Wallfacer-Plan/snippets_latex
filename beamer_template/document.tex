...
\logo{\includegraphics[scale=.25]{sjtu_name_darkblue.png}}
...
\href{run:Akon_Right_ 
  Now.mp3}{\includegraphics[width=.2\textwidth]{akon.jpg}}
\end{center}
}
\item<2-> or movie\\
\begin{center}
\href{run:lovely.flv}{\includegraphics[width=.2\textwidth]{chx.jpeg}}
\end{center}
\end{itemize}
\end{frame}
