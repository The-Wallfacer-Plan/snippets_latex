...
\begin{frame}
  ...
  \begin{itemize}
  \item Execute programs with \alert{symbol values} rather
  ...
  \item[\ding{51}] Generate test with higher coverage
...
\begin{frame}
  ...
  \item[\ding{55}] The weight is various(e.g. query cost, minimum distance to an
    uncovered instruction, call stack,etc) thus not general, and the algorithm may be costly
